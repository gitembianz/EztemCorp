...
return [
    ...
    "metadescription" => "We provide creative digital solutions for your business. Expertise in graphic design, retouch, web development, and online marketing.",
    "hero" => [
    ...
    "details" => [
        ...
        "card_web3" => [
            "heading" => "Retouch",
            "description" => "Harmony between shapes, colors, and lights is essential. Careful manipulation of these elements can reveal the meaning of beauty in photo composition.",
            "button" => "See Retouch"
        ],
        "card_web4" => [
            "heading" => "Marketing",
